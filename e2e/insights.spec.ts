...
test('public insights pages render without auth', async ({ page }) => {
  ...
  await page.goto('/insights/year/2025/product/banking-and-payments');
  ...
  await page.goto('/insights/firm/lloyds-bank-plc/product/payment-protection-insurance-ppi');
